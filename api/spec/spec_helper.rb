...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    users = [
      ...
      { name: "Silvio Santos", email: "silviosantos@gmail.com", password: to_md5("pwd123") },
      { name: "Joe Perry", email: "joe@gmail.com", password: to_md5("pwd123") },
      { name: "Ed Curry", email: "ed@gmail.com", password: to_md5("pwd123") },
      { name: "Pitty", email: "pitty@bol.com.br", password: to_md5("pwd123") },
    ]
